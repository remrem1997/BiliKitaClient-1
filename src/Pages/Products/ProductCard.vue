    ...
    <div class="row">
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                <div class="product-image">
                    <a href="#" class="image">
                        <img class="pic-1" src="./banana.jpg">
                        <img class="pic-2" src="./banana2.jpg">
                    </a>
                ...
                <div class="product-content">
                    ...
                    <h3 class="title"><a href="#">Banana</a></h3>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                <div class="product-image">
                    <a href="#" class="image">
                        <img class="pic-1" src="./rambutan1.jpg">
                        <img class="pic-2" src="./rambutan2.jpg">
                    </a>
                    <span class="product-sale-label">hot</span>
                </div>
                <div class="product-content">
